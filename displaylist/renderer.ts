...
module render {
    ...
    export class DisplayObject {
        ...
        draw(context: CanvasRenderingContext2D) {
            ...
            if (!parent) {
                ...
                this.globalMatrix = matrix_multiply(localMatrix,parent.globalMatrix);
            }
    ...
    function matrix_multiply(m1:Matrix,m2:Matrix):Matrix {
        var final=new Matrix();
        final.a=m1.a*m2.a+m1.b*m2.c;
        final.b=m1.a*m2.b+m1.b*m2.d;
        final.c=m1.c*m2.a+m1.d*m2.c;
        final.d=m1.c*m2.b+m1.d*m2.d;
        final.tx=m1.tx*m2.a+m1.ty*m2.c+m2.tx;
        final.ty=m1.tx*m2.b+m1.ty*m2.d+m2.ty;
        return final;
    }
